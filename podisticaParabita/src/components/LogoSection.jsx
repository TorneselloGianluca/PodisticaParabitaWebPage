  ...
  return (
    <section className="py-12 px-4 md:px-8 bg-white relative z-20 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Container principale: Sfondo Slate-900, ombra aggiornata in orange-900/20 */}
        <div className="bg-slate-900 rounded-[2.5rem] md:rounded-[3rem] p-6 md:p-16 border border-white/5 shadow-2xl shadow-orange-900/20">
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            
            {/* 1. IL LOGO */}
            <div className="lg:col-span-5 flex justify-center order-1 lg:order-1">
              <div className="relative group">
                {/* Aura arancione modificata: bg-orange-600/30 */}
                <div className="absolute inset-0 bg-orange-600/30 rounded-full blur-3xl group-hover:bg-orange-500/40 transition-colors duration-700"></div>
            ...
            <div className="lg:col-span-7 space-y-6 md:space-y-8 w-full min-w-0 order-2 lg:order-2">
              <div className="text-center lg:text-left">
                {/* Badge modificato: bg-orange-600/20, text-orange-400, border-orange-500/20 */}
                <span className="inline-flex items-center gap-2 bg-orange-600/20 text-orange-400 px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase mb-4 border border-orange-500/20">
                  <Star size={12} fill="currentColor" /> Identity Card
                </span>
                {/* Titolo DNA modificato: text-orange-500 */}
                <h2 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter leading-none">
                  Il Nostro <span className="text-orange-500">DNA</span>
                </h2>
              ...
              <div className="w-full min-w-0">
                ...
                <div className="flex overflow-x-auto pb-6 gap-4 snap-x snap-mandatory lg:grid lg:grid-cols-2 lg:overflow-visible lg:pb-0 scrollbar-hide">
                  ...
                  {/* Valore 1 - Icone e sfondi modificati in orange */}
                  <div className="flex items-center gap-4 bg-white/5 p-4 md:p-5 rounded-2xl border border-white/10 shadow-sm min-w-[240px] md:min-w-0 flex-shrink-0 snap-center">
                    <div className="bg-orange-600/20 p-3 rounded-full text-orange-500 shrink-0">
                      <ShieldCheck size={24} />
                    </div>
                    <div>
