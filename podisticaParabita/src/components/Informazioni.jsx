            ...
            <div className="space-y-6 md:space-y-10">
              <div>
                <div className="inline-flex items-center gap-3 mb-4 md:mb-6">
                  ...
                  <span className="h-px w-8 md:w-12 bg-orange-600"></span>
                  {/* Modificato: text-blue-600 -> text-orange-600 */}
                  <span className="text-orange-600 font-black uppercase tracking-[0.2em] text-[10px] md:text-xs">La nostra identità</span>
                </div>
                <h2 className="text-4xl md:text-6xl lg:text-7xl font-black text-slate-900 uppercase tracking-tighter leading-[0.9] lg:leading-[0.85]">
                  Storia & <br />
                  {/* Modificato: text-blue-600 -> text-orange-600 */}
                  <span className="text-orange-600">Passione</span>
                </h2>
              </div>

              <div className="space-y-4 md:space-y-6 text-slate-600 leading-relaxed text-base md:text-xl">
                <p className="font-medium text-slate-900">
                  {/* Modificato: border-blue-500/20 -> border-orange-500/20 */}
                  Dal 1980, la <span className="border-b-2 border-orange-500/20">Podistica Parabita</span> scrive pagine di sport e vita nel Salento.
                </p>
                  ...
                  <div className="relative h-full w-full overflow-hidden">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 md:bottom-12 md:left-12 z-20">
                      <div className="inline-flex items-center gap-3 bg-white/95 backdrop-blur-md p-3 md:p-5 rounded-xl md:rounded-2xl shadow-2xl border border-white/20">
                        {/* Modificato: bg-blue-600 -> bg-orange-600 */}
                        <div className="bg-orange-600 p-1.5 md:p-2 rounded-lg text-white shrink-0">
                          <Award size={18} />
                        </div>
